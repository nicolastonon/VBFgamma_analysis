...
regions=(SR_HighVPt SR_LowVPt CRee_HighVPt CRee_LowVPt CRmm_HighVPt CRmm_LowVPt) #All
# regions=(SR_HighVPt SR_LowVPt) #SR only
# regions=(CRee_HighVPt CRee_LowVPt CRmm_HighVPt CRmm_LowVPt) #CR only
# regions=(CRmm_LowVPt)
